...
import dishList from './components/Administrative/system/dish/list.vue'
...
const routes = [
  ...
  },
  {
    ...
    component: Home,
    children: [
      { path: 'dish/list', component: dishList, name: 'dishList', meta: { hideLeft: false, module: 'Administrative', menu: 'systemConfig' }}
    ]
  }
]
